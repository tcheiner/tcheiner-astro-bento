...
The only portion I did not develop was the stable diffusion workflows.  I wanted to tackle that to round out my
...
![my pixar representation](/images/projects/genai-sd/tcheina.png)
