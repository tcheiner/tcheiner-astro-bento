...
### Key Features Implemented
  ...
  # 3. Or start server and test manually
  uvicorn chatbot.main:app --reload

  To Deploy to Lambda:
  1. Add ANTHROPIC_API_KEY to AWS SSM Parameter Store
  2. Update Docker container (new dependencies needed)
  3. Set USE_MULTI_AGENT=true in Lambda environment
  4. Optionally: Add recommended behavioral tags to blog posts (see IMPLEMENTATION_STATUS.md)

  Cost & Performance

  - SKILLS: $0.002/query, <2 sec latency
  - BEHAVIORAL: $0.015-0.022/query, <3 sec latency
