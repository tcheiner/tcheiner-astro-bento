...
tags: ["MCP", "Model Context Protocol", "AWS", "Serverless", "Typescript", "Lambda", "API"]
...
After all that troubleshooting, I see this section on the MCP website SPECIFICALLY for vibe coding:
...
I made a simple diagram (any excuse to practice diagramming with DiagramsAsCode) to show the architecture of what was
implemented and checked it into Github as well.
