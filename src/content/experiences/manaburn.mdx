...
I also started implementing a config server within AWS as we needed to store and share several
API keys between our meme generator, mobile gaming app, and backend.
...
of regard for the wonderful team at Manaburn.  I have been, and will be turning down opportunities for games.
