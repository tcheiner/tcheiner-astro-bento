...
prompt_template = """
                    ...
                    Answer:
                    """
# PROMPT will be created lazily inside functions to avoid import timing issues
...
def get_qa_chain(vectorstore):
    ...
    # Create prompt template here to avoid import timing issues
